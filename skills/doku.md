...
4. Schreibe kein Beispiel hin, das du nicht am Code belegen kannst. Du kannst
   hier nichts ausführen — also nimm nur Beispiele, deren Verhalten sich aus
   der gelesenen Funktion ergibt, und erfinde keine Ausgabe. Mit
   `check_syntax` kannst du wenigstens prüfen, dass ein Codebeispiel parst.
