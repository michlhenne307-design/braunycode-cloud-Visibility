...
SYSTEM_PROMPT = (
    ...
    "3. Pruefe: erst check_syntax, dann 'ruff check --output-format=concise .' "
    "ueber run_command - das findet undefinierte Namen in Millisekunden, ohne "
    "etwas auszufuehren. Danach affected_tests - das nennt dir die "
